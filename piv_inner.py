...
def piv_inner(date, num_tests, utau):
	...
	# ### WUMOIN DATA #######
	wumoin = dict()
	wumoin = pd.read_hdf('data/outside_data/WuMoin2010.h5', 'zpg_re1840')
	# ## Reza Data ##
	...
	###############################################
	legend1 = [r'$Re_\tau=$1450', r'$Re_\tau=$2180', r'$Re_\tau=$2280', r'$Re_\tau=$3270', r'$Re_\tau=$5680', r'$Re_\tau=$6430', r'$Re_\tau=$10770', r'$Re_\tau=$15480', r'$Re_\tau=$15740', r'$Re_{\theta}=$7705, Adrian',]
	...
	##Urmsplus Yplus
	plt.figure()
	legend1 =  [r'$Re_\tau=$6430, Hot-Wire', r'$Re_{\theta}=$1840, WuMoin', r'$Re_{\theta}=$7705, Adrian', r'Conf Int.']
	...
	##UVprimeplus Yplus
	legend1 =  [r'$Re_{\theta}=$1840, WuMoin', r'$Re_{\theta}=$7705, Adrian', r'Conf Int']
	plt.figure()
	#WuMoin
